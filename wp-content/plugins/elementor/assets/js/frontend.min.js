    ...
    [819], {
        ...
        8628: (e, t) => {
            ...
            t.default = class Swiper {
                constructor(e, t) {
                    return this.config = t, this.config.breakpoints && (this.config = this.adjustConfig(t)), e.closest(".elementor-widget-wrap").addClass("e-swiper-container"), new Promise((t => {
