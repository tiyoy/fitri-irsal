...
! function(t, e) {
    ...
    var Ye = rt(function(t) {
        ...
        return Be(e, "bdt-" + t), t = Ue(e, "content", ":before").replace(/^["'](.*)["']$/, "$1"), $e(e), t
    });

    function Xe(t) {
        return ht ? Ye(t) : qe(document.documentElement).getPropertyValue("--bdt-" + t)
    }
        ...
        return void 0 === a && (a = 400), void 0 === u && (u = "linear"), he.all(W(t).map(function(o) {
            return new he(function(e, n) {
                ...
                Qt(o, "transitionend transitioncanceled", function(t) {
                    t = t.type;
                    clearTimeout(r), De(o, "bdt-transition"), Re(o, {
                        transitionProperty: "",
                        transitionDuration: "",
        ...
        return void 0 === s && (s = 200), he.all(W(t).map(function(r) {
            return new he(function(e, n) {
                ...
                Qt(r, "animationend animationcanceled", function(t) {
                    ...
                    self: !0
                }), Re(r, "animationDuration", s + "ms"), Be(r, o, Qe + (u ? "leave" : "enter")), g(o, Qe) && (a && Be(r, "bdt-transform-origin-" + a), u && Be(r, Qe + "reverse"))
            })
        }))
    }
    ...
    var ti, ei, ni, ii, ri, oi, si, ai, ui, ci = rt(function(t) {
        return !(!g(t, "bdt-") && !g(t, "data-bdt-")) && f(t.replace("data-bdt-", "").replace("bdt-", ""))
    });
    ...
    Qn.util = Zn, Qn.data = "__uikit__", Qn.prefix = "bdt-", Qn.options = {}, Qn.version = "3.7.2", ni = (ti = Qn).data, ti.use = function(t) {
    ...
    var zi = {
        ...
        connected: function() {
            this.masonry && Be(this.$el, "bdt-flex-top bdt-flex-wrap-top")
        },
        update: [{
            write: function(t) {
                t = t.columns;
    ...
    var Hi = {
        ...
        Li = {
            ...
            update: {
                ...
                write: function() {
                    var t, e;
                    t = this.svgEl, (e = Vi(t)) && t.style.setProperty("--bdt-animation-stroke", e)
                },
                type: ["resize"]
            },
            methods: {
    ...
    var Yi = {
        ...
        Ki = {
            extends: Gi,
            beforeConnect: function() {
                Be(this.$el, "bdt-slidenav")
            },
            computed: {
                icon: function(t, e) {
                    t = t.icon;
                    return He(e, "bdt-slidenav-large") ? t + "-large" : t
                }
            }
        },
        Ji = {
            ...
            computed: {
                icon: function(t, e) {
                    t = t.icon;
                    return He(e, "bdt-search-icon") && Dt(e, ".bdt-search-large").length ? "search-large" : Dt(e, ".bdt-search-navbar").length ? "search-navbar" : t
                }
            }
        },
        Zi = {
            ...
            computed: {
                icon: function() {
                    return "close-" + (He(this.$el, "bdt-close-large") ? "large" : "icon")
                }
            }
        },
        Qi = {
    ...
    var vr = {
        install: function(t) {
            ...
            a.dialog = function(t, e) {
                var n = a('<div class="bdt-modal"> <div class="bdt-modal-dialog">' + t + "</div> </div>", e);
                ...
                return i(function(t) {
                    t = t.labels;
                    return '<div class="bdt-modal-body">' + (z(e) ? e : we(e)) + '</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>' + t.ok + "</button> </div>"
                }, t, function(t) {
                    return t.resolve()
                })
                ...
                return i(function(t) {
                    t = t.labels;
                    return '<form> <div class="bdt-modal-body">' + (z(e) ? e : we(e)) + '</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">' + t.cancel + '</button> <button class="bdt-button bdt-button-primary" autofocus>' + t.ok + "</button> </div> </form>"
                }, t, function(t) {
                    return t.reject()
                })
                ...
                return i(function(t) {
                    t = t.labels;
                    return '<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>' + (z(e) ? e : we(e)) + '</label> <input class="bdt-input" value="' + (n || "") + '" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">' + t.cancel + '</button> <button class="bdt-button bdt-button-primary">' + t.ok + "</button> </div> </form>"
                }, t, function(t) {
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                He(this.panel, "bdt-margin-auto-vertical") ? Be(this.$el, "bdt-flex") : Re(this.$el, "display", "block"), cn(this.$el)
            }
        }, {
            name: "hidden",
            self: !0,
            handler: function() {
                Re(this.$el, "display", ""), De(this.$el, "bdt-flex")
            }
        }]
    };
    o = ".bdt-navbar-nav > li > a, .bdt-navbar-item, .bdt-navbar-toggle", l = {
        mixins: [pi, $i, Bi],
        props: {
            dropdown: String,
            mode: "list",
        ...
        computed: {
            ...
            dropbar: {
                get: function(t) {
                    t = t.dropbar;
                    return t ? (t = this._dropbar || Ht(t, this.$el) || Me("+ .bdt-navbar-dropbar", this.$el)) || (this._dropbar = Me("<div></div>")) : null
                },
                watch: function(t) {
                    Be(t, "bdt-navbar-dropbar")
                },
                immediate: !0
            },
        ...
        events: [{
            ...
            handler: function(t, e) {
                var n = e.$el,
                    e = e.dir;
                He(n, this.clsDrop) && ("slide" === this.dropbarMode && Be(this.dropbar, "bdt-navbar-dropbar-slide"), this.clsDrop && Be(n, this.clsDrop + "-dropbar"), "bottom" === e && this.transitionTo(n.offsetHeight + L(Re(n, "marginTop")) + L(Re(n, "marginBottom")), n))
            }
        }, {
            name: "beforehide",
            el: function() {
    ...
    var dt = {
        ...
        _t = {
            ...
            update: [{
                read: function(t) {
                    ...
                    this.elements.forEach(function(t) {
                        t[br] || (t[br] = {
                            cls: ut(t, "bdt-scrollspy-class") || e.cls
            ...
            methods: {
                toggle: function(t, e) {
                    var n = t[br];
                    n.off && n.off(), Re(t, "visibility", !e && this.hidden ? "hidden" : ""), Le(t, this.inViewClass, e), Le(t, n.cls), /\bbdt-animation-/.test(n.cls) && (n.off = Qt(t, "animationcancel animationend", function() {
                        return Oe(t, "bdt-animation-[\\w-]+")
        ...
        Zn = {
            ...
            connected: function() {
                this.placeholder = Me("+ .bdt-sticky-placeholder", this.$el) || Me('<div class="bdt-sticky-placeholder"></div>'), this.isFixed = !1, this.isActive = !1
            },
            disconnected: function() {
    ...
    var yr, kr, $r, lr = {
                ...
                toggles: {
                    get: function(t, e) {
                        return ze(t.toggle, e).filter(function(t) {
                            return !Mt(t, ".bdt-disabled *, .bdt-disabled, [disabled]")
                        })
                    },
                    watch: function(t) {
                        var e = this.index();
        ...
        Bi = {
            ...
            connected: function() {
                var t = He(this.$el, "bdt-tab-left") ? "bdt-tab-left" : !!He(this.$el, "bdt-tab-right") && "bdt-tab-right";
    ...
    G(Object.freeze({
        ...
        Responsive: {
            props: ["width", "height"],
            connected: function() {
                Be(this.$el, "bdt-responsive-width")
            },
            update: {
                read: function() {
        ...
        ct && (n = function() {
            ...
            t = t.target;
            (Re(t, "animationName") || "").match(/^bdt-.*(left|right)/) && (r++, Re(document.documentElement, "overflowX", "hidden"), setTimeout(function() {
    ...
    var Tr = "bdt-transition-leave",
        Cr = "bdt-transition-enter";
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        ...
                        Le(t, n.clsActive, H(e) === i), Le(t, "bdt-invisible", n.finite && ("previous" === e && 0 === i || "next" === e && i >= n.maxIndex))
                    })
                }
            }
        }],
        ...
        qr = {
            ...
            events: [{
                ...
                handler: function(t, n) {
                    ...
                    var s, a, u, c = n.poster,
                        h = n.attrs;
                    void 0 === h && (h = {}), this.setItem(n, "<span bdt-spinner></span>"), r && (a = {
                        frameborder: "0",
                        allow: "autoplay",
                        allowfullscreen: "",
            ...
            methods: {
                ...
                showControls: function() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), Be(this.$el, "bdt-active", "bdt-transition-active")
                },
    ...
    Gi = {
        ...
        created: function() {
            ...
            this.$mount(be(t, '<div class="' + this.clsMsg + (this.status ? " " + this.clsMsg + "-" + this.status : "") + '"> <a href class="' + this.clsClose + '" data-bdt-close></a> <div>' + this.message + "</div> </div>"))
        },
        connected: function() {
            var t, e = this,
